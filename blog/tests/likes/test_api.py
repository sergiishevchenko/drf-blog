...
class TestLikes:
    def test_anonymous_user_can_not_like_a_post_return_401(self, api_client, media_root, create_post):
    ...
    def test_delete_like(self, api_client, user_factory, post_factory, like_factory, media_root):
        user = user_factory.create()
        post = post_factory.create()
