...
from posts.models import Category, Comment, Like, Post, FavoritePost
from posts.selectors import get_comment, get_comments, get_post, get_posts
from posts.services import create_comment, create_post, delete_comment, delete_post, update_comment, update_post
from users.models import Profile

from .paginations import PostCommentPagination, PostPagination, get_paginated_response_context
from .permissions import CommentUserOrReadOnly, IsAdminUserOrReadOnly, IsOwnerOrReadOnly
from .serializers import CategorySerializer, CommentSerializer, FilterSerializer, PostSerializer
...
class FavoritePostViewSet(ViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if favorite_post.exists():
            ...
            return Response({'detail': 'This post has been removed from your favorites.'})
        else:
